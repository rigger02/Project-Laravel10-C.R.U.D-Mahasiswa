                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="{{route('store')}}">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="nama" name="nama_murid">
                        </div>
                        <div class="mb-3">
                          <label for="umur" class="form-label">Masukan Umur</label>
                          <input type="text" class="form-control" id="umur" name="umur_murid">
                        </div>
                        <div class="mb-3">
                          <label for="hobi" class="form-label">Masukan Hobi</label>
                          <input type="text" class="form-control" id="hobi" name="hobi_murid">
                        </div>
